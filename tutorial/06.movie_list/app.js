const movies = [
    {
        ...
        title: '로마',
        director: '알폰소 쿠아론',
        poster: 'https://img1.daumcdn.net/thumb/R800x0/?scode=mtistory2&fname=https%3A%2F%2Ft1.daumcdn.net%2Fcfile%2Ftistory%2F99EE9D3F5C7D368E35',
    ...
    },
    {
        ...
        title: '예언자',
        director: '자크 오디아르',
        poster: 'http://image.cine21.com/resize/cine21/still/2010/0205/M0020009__still_02[S600,600].jpg',
...
next.addEventListener('click', function () {
    ...
    if (currentIndex > movies.length - 1) {
        // 현재 인덱스가 전체 무비의 수보다 커졌을 경우에 실행된다
        // 인덱스는 0부터 시작이기 때문에 -1 을 붙여서 갯수를 맞춘다
        currentIndex = 0;
    }
...
function showMovie(inedx) {
    const item = movies[inedx];
